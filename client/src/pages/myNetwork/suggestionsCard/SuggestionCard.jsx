...
const SuggestionCard = ({  nameBody,handleOnClick}) => {
  return (
    ...
    <Stack flexDirection={'column'} sx={{m:0 ,pb:1.5,pl:'12px', pr:'12px',justifyContent:'center', alignItems:'center' }}>
        ...
        <Typography mt={'12px'} fontSize={'12px'} color={'#999999'} textAlign={'center'} >20 mutual connections</Typography>
        <Button variant='outlined' onClick={handleOnClick} sx={{textTransform:'none',fontWeight:'550', fontSize:'16px' ,borderRadius:'30px',p:'0',display:'flex', gap:'5px' , mt:'12px', width:'100%'}}>  Connect</Button>
